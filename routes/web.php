...
Route::get('/index',['as'=>'client.index','uses'=>'LoginCusController@Homeclient']);
route::get('loginclient','LoginCusController@HomeLogin');
route::get('dang-ky','LoginCusController@getCustomer');
route::post('dang-ky','LoginCusController@postCustomer');
Route::get('dang-nhap','LoginCusController@getLogin');
Route::post('dang-nhap','LoginCusController@postLogin');
Route::get('dang-xuat','LoginCusController@getLogout');
...
Route::get('danh-sach-san-pham-tag/{id}',['as'=>'listRelatedTag','uses'=>'HomeController@listRelatedTag']);
Route::get('thanh-toan',['as'=>'client.cart.checkout','middleware'=>'customerlogin','uses'=>'HomeController@getCheckout']);
Route::post('thanh-toan',['as'=>'client.cart.checkout','middleware'=>'customerlogin','uses'=>'HomeController@postCheckout']);
Route::get('/index',['as'=>'client.index','uses'=>'HomeController@homePage']);


Route::get('/search',['as'=>'search','uses'=>'HomeController@searchPrice']);
...
Route::group(['prefix'=>'admin','middleware'=>'adminlogin'],function(){
    ...
    Route::get('/index',['as'=>'admin.index','uses'=>'UserController@HomeAdmin']);
    ...
    route::get('hoa-don',['as'=>'admin.order.order','uses'=>'OrderController@getOrder']);
    route::get('xoa-hoa-don/{id}',['as'=>'admin.order.getDelete','uses'=>'OrderController@getDelete']);
    route::get('thay-doi-status-order/{id}',['as'=>'admin.order.changeStatus','uses'=>'OrderController@changeStatus']);
    ...
    route::group(['prefix'=>'nguoi-dung'],function(){
        ...
        route::post('them-nguoi-dung',['as'=>'admin.user.adduser','uses'=>'UserController@postUser']);
        route::get('thay-doi-status-user/{id}',['as'=>'admin.user.changeStatus','uses'=>'UserController@changeStatus']);
        route::get('xoa-user/{id}',['as'=>'admin.user.getDelete','uses'=>'UserController@getDelete']);
        route::get('sua-user/{id}',['as'=>'admin.user.getEdit','uses'=>'UserController@getEdit']);
        route::post('sua-user/{id}',['as'=>'admin.user.postEdit','uses'=>'UserController@postEdit']);
        ...
        route::post('them-nhom-nguoi-dung',['as'=>'admin.user.addusergroup','uses'=>'UserGroupController@postUserGroup']);
        route::get('thay-doi-status-usergroup/{id}',['as'=>'admin.usergroup.changeStatus','uses'=>'UserGroupController@changeStatus']);
        route::get('xoa-usergroup/{id}',['as'=>'admin.usergroup.getDelete','uses'=>'UserGroupController@getDelete']);
        route::get('sua-usergroup/{id}',['as'=>'admin.usergroup.getEdit','uses'=>'UserGroupController@getEdit']);
        route::post('sua-usergroup/{id}',['as'=>'admin.usergroup.postEdit','uses'=>'UserGroupController@postEdit']);
        

        route::group(['prefix'=>'phan-quyen'],function(){
            route::get('/',['as'=>'admin.role.role','uses'=>'RoleController@Home']);
            route::get('them-quyen',['as'=>'admin.role.addrole','uses'=>'RoleController@getRole']);
            route::post('them-quyen',['as'=>'admin.role.addrole','uses'=>'RoleController@postRole']);
            route::get('xoa-role/{id}',['as'=>'admin.role.getDelete','uses'=>'RoleController@getDelete']);

            route::get('phan-quyen',['as'=>'admin.role.permission','uses'=>'PermissionController@Home']);
            route::get('them-phan-quyen',['as'=>'admin.role.addpermission','uses'=>'PermissionController@getPermission']);
            route::post('them-phan-quyen',['as'=>'admin.role.addpermission','uses'=>'PermissionController@postPermission']);
            route::get('thay-doi-status-permission/{id}',['as'=>'admin.permission.changeStatus','uses'=>'PermissionController@changeStatus']);
            route::get('xoa-permission/{id}',['as'=>'admin.permission.getDelete','uses'=>'PermissionController@getDelete']);
        });
    });
