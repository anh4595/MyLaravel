        ...
        <div class="row">
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    ...
                    @foreach($product_tag as $itemproduct)
                ...
                <div class="sortPagiBar">
                    <div class="bottom-pagination">
                        <nav>
                          <ul class="pagination">
                            @if($product_tag->currentPage() != 1)
								<li>
									<a href="{!! str_replace('/?','?',$product_tag->url($product_tag->currentPage() - 1)) !!}" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
									</a>
								</li>
								@endif
								@for($i=1;$i<=$product_tag->lastPage();$i=$i+1)
								<li class = "{!! ($product_tag->currentPage() == $i) ? 'active' : '' !!}">
									<a href="{!! str_replace('/?','?',$product_tag->url($i)) !!}">{{ $i }}</a>
								</li>
								@endfor
								@if($product_tag->currentPage() != $product_tag->lastPage())
								<li>
									<a href="{!! str_replace('/?','?',$product_tag->url($product_tag->currentPage() + 1)) !!}" aria-label="Next">
