                            ...
                            <li>
                             ...
                             <div class="products-block">
                                <div class="products-block-bottom">
                                    <a class="link-all" href="{!! url('danh-sach-san-pham',[$item->id,$item->metatitle]) !!}">All Products</a>
                                </div>
                            </div>
                            @endforeach
                        </ul>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title">SẢN PHẨM GIẢM GIÁ - SALE</span>
                    </h2>
                    ...
                    @foreach($product_sale as $itemproduct)
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="{!! url('chi-tiet-san-pham',[$itemproduct->id,$itemproduct->metatitle]) !!}">
                                ...
                                <div class="right-block">
                                    <h5 class="product-name"><a href="{!! url('chi-tiet-san-pham',[$itemproduct->id,$itemproduct->metatitle]) !!}">{!! $itemproduct->name !!}</a></h5>
                                    ...
                                    <div class="content_price">
                                        <span class="price product-price">${!! number_format($itemproduct->promotionprice,0,",",".") !!}</span>
                                        <span class="price old-price">${!! number_format($itemproduct->price,0,",",".") !!}</span>
                                    </div>
                ...
                <div class="sortPagiBar">
                    <div class="bottom-pagination">
                        <nav>
                          <ul class="pagination">
                            @if($product_sale->currentPage() != 1)
								<li>
									<a href="{!! str_replace('/?','?',$product_sale->url($product_sale->currentPage() - 1)) !!}" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
									</a>
								</li>
								@endif
								@for($i=1;$i<=$product_sale->lastPage();$i=$i+1)
								<li class = "{!! ($product_sale->currentPage() == $i) ? 'active' : '' !!}">
									<a href="{!! str_replace('/?','?',$product_sale->url($i)) !!}">{{ $i }}</a>
								</li>
								@endfor
								@if($product_sale->currentPage() != $product_sale->lastPage())
								<li>
									<a href="{!! str_replace('/?','?',$product_sale->url($product_sale->currentPage() + 1)) !!}" aria-label="Next">
