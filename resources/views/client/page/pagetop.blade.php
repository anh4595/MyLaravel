                ...
                <div class="popular-tabs">
                      ...
                      <div class="tab-container">
                            <div id="tab-111" class="tab-panel active">
                                ...
                                <?php
                                    $list_best=DB::table('products')->where('status',1)->orderby('viewcount','DESC')->skip(0)->take(5)->get();
                                ?>
                                ...
                                @foreach($list_sale as $itemsale)
                                    <li>
                                        <div class="left-block">
                                            ...
                                            <div class="add-to-cart">
                                                <a title="Add to Cart" href="{!! url('mua-hang',[$itemsale->id,$itemsale->metatitle]) !!}">Add to Cart</a>
                                            </div>
                                        </div>
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="{!! url('chi-tiet-san-pham',[$itemsale->id,$itemsale->metatitle]) !!}">{!! $itemsale->name !!}</a></h5>
                                            <div class="content_price">
                                                <span class="price product-price">${!! number_format($itemsale->promotionprice,0,",",".") !!}</span>
                                                <span class="price old-price">${!! number_format($itemsale->price,0,",",".") !!}</span>
                                            </div>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                ...
                                @foreach($list_new as $itemnew)
                                    <li>
                                        <div class="left-block">
                                            ...
                                            <div class="add-to-cart">
                                                <a title="Add to Cart" href="{!! url('mua-hang',[$itemnew->id,$itemnew->metatitle]) !!}">Add to Cart</a>
                                            </div>
                                        </div>
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="{!! url('chi-tiet-san-pham',[$itemnew->id,$itemnew->metatitle]) !!}">{!! $itemnew->name !!}</a></h5>
                                            <div class="content_price">
                                                <span class="price product-price">${!! number_format($itemnew->price,0,",",".") !!}</span>
                                                <span class="price old-price">${!! number_format($itemnew->promotionprice,0,",",".") !!}</span>
                                            </div>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                        ...
                        @foreach($list_deals as $itemdeals)
                            <li>
                                ...
                                <div class="left-block">
                                    ...
                                    <div class="add-to-cart">
                                        <a title="Add to Cart" href="{!! url('mua-hang',[$itemdeals->id,$itemdeals->metatitle]) !!}">Add to Cart</a>
                                    </div>
                                </div>
                                <div class="right-block">
                                    <h5 class="product-name"><a href="{!! url('chi-tiet-san-pham',[$itemdeals->id,$itemdeals->metatitle]) !!}">{!! $itemdeals->name !!}</a></h5>
                                    <div class="content_price">
                                        <span class="price product-price">${!! number_format($itemdeals->promotionprice,0,",",".") !!}</span>
                                        <span class="price old-price">${!! number_format($itemdeals->price,0,",",".") !!}</span>
