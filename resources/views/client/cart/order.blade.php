                ...
                <table class="table table-bordered table-responsive cart_summary">
                    ...
                    <form action="" method="POST">
                        ...
                        @foreach($content as $item)
                            <tr>
                                ...
                                <td class="qty">
                                    <input data-id="{!! $item->rowId !!}" data-price="{!! $item->price !!}" class="autoupdate form-control input-sm" type="text" value='{!! $item->qty !!}'>
                                </td>
                                <td class="price">
                                    <span id="total_{!! $item->rowId !!}">${!! number_format(($item->price)*($item->qty),0,",",".") !!}</span>
                                </td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td colspan="2" id="subtotal" value="{!!  $total !!}"><strong>${!! $total !!}</strong></td>
                        </tr>
                    </tfoot>    
                </table>
