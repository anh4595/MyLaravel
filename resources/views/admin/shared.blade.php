				...
				<div class = "nav-side-menu">
					...
					<div class = "menu-list">
						<ul id = "menu-content" class = "menu-content collapse">
							...
							<li><a href = "{!! URL('admin/hoa-don') !!}"><span class = "glyphicon glyphicon-barcode" aria-hidden = "true">&nbsp;</span>Tất cả hóa đơn</a></li>
				...
				<nav class = "navbar navbar-default">
					<ul class = "nav navbar-nav navbar-right">
						...
						<li class = "dropdown active">
							<a href = "#" class = "dropdown-toggle" data-toggle = "dropdown" role = "button" aria-haspopup = "true" aria-expanded = "false">{{ Auth::user()->name }}<span class = "caret caret-fix"></span></a>
